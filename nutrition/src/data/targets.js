...
window.NUTRIENTS = [
  ...
  { key: "iron",      he: "ברזל",           unit: "מ\"ג",  group: "mineral", ul: 45,   ulSoft: true, ulNote: "הגבול נקבע לאדם בריא; בטיפול בחסר ברזל לפי הנחיית רופא/ה מינון גבוה יותר מקובל.", kind: "target", hero: true },
  ...
  { key: "folate",    he: "חומצה פולית",    unit: "מק\"ג", group: "vitamin", ul: 1000, ulSoft: true, ulNote: "הגבול חל רק על חומצה פולית סינתטית (תוספים/מזון מועשר); פולאט טבעי מקטניות וירקות בטוח בכל כמות.", kind: "target" },
  ...
  { key: "vitA",      he: "ויטמין A",       unit: "מק\"ג", group: "vitamin", ul: 3000, ulSoft: true, ulNote: "הגבול חל על רטינול (מהחי/תוספים). בטא-קרוטן מגזר, בטטה וירקות כתומים בטוח ואינו נספר לגבול.", kind: "target" },
