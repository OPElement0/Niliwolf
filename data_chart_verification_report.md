...
**Generated:** 2026-05-11 22:24  
**Source:** `wolves_data.xlsx`, sheet `נתוני זיהוי זאבים (2)`  
**HTML:** `data_table.html` (build_iso: `2026-05-06 20:17`)
...
| rows with `code` AND `#pictures > 0` (load_data pool) | 99 |
| region cells in table (rows × 9 regions) | 936 |
| HTML reports `n_total_rows` | 104 |
| HTML reports `n_pool` | 100 |

## 3. Layer 1 — per-cell status (table colour bars)

Checked **936** region cells against `process_all_regions`.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| A1 | 55 | 27 | 9 | 0 | 0 | 0 | 0 | 2 | 6 | 0 | 1 | 0 |
| A2 | 18 | 30 | 35 | 0 | 0 | 0 | 0 | 3 | 7 | 0 | 7 | 0 |
| B3 | 2 | 8 | 4 | 8 | 11 | 0 | 0 | 2 | 32 | 4 | 29 | 0 |
| B4 | 2 | 3 | 10 | 33 | 11 | 0 | 0 | 3 | 9 | 9 | 20 | 0 |
| B5 | 3 | 3 | 13 | 8 | 30 | 0 | 0 | 3 | 11 | 4 | 25 | 0 |
| C6 | 26 | 19 | 27 | 18 | 0 | 0 | 0 | 0 | 5 | 1 | 4 | 0 |
| C7 | 1 | 3 | 6 | 0 | 41 | 29 | 0 | 0 | 1 | 5 | 14 | 0 |
| D8 | 9 | 12 | 14 | 0 | 20 | 0 | 0 | 0 | 36 | 2 | 7 | 0 |
| D9 | 0 | 0 | 6 | 0 | 13 | 21 | 40 | 0 | 0 | 2 | 18 | 0 |
...
✅ **All 207 distinct codes (across 9 regions) match expected counts.**
